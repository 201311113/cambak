...
class CampingCarDto {
    ...
    class GetCampingCarListRes(
        code: Int,
        @ApiModelProperty(name = "캠핑카 리스트업 정보", value = "22.10.12 아직 정확한 DTO 미정")
        var campingCarList: List<CampingCarInfo>? = null
    ):Response(code){
...
//            var mainImageUrl: String,
    ...
    //캠핑카 상세조회
    class GetCampingCarDetailRes(
        code: Int,
        var campingCarDetail: CampingCarDetail ?= null
    ){
        class CampingCarDetail(
            var id: String,
            var productName: String,
            var oneLineDescription: String,
            var description: String,
